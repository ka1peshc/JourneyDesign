...
@Component({
    tag: 'wf-communication-field',
    styleUrl: 'communication-field.scss',
    shadow: false
})

export class CommunicationField { 
...
//   multiline: boolean;
  ...
  render() {
    ...
    const syntaxes = ['welcome to program', 'referral code', 'custom profile update','custom orra website msg','profile update','custom profile update silver','custom REP','custom EMI','custom other'];
