...
@Component({
    tag: 'wf-delay-field',
    styleUrl: 'delay-field.scss',
    shadow: false
})

export class DelayField { 
...
//   multiline: boolean;
  ...
  render() {
    ...
    const syntaxes = ['Profile updated & 7 Days','Profile updated & 12 Days','Profile updated & 30 Days','15 Days','30 Days','other'];
