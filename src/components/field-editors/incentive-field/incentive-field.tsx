...
@Component({
    tag: 'wf-incentive-field',
    styleUrl: 'incentive-field.scss',
    shadow: false
})
...
//   multiline: boolean;
  ...
  render() {
    ...
    const syntaxes = ['Single Criteria Recency','Collecta feedback','Profile update points','Miss you points','Profile Updated GV','others'];
    const selectedSyntax = this.syntax || 'others';
